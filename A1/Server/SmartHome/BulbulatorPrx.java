...
public interface BulbulatorPrx extends SmartDevicePrx
{
    ...
    {
        return _iceI_bulbulAsync(context, true).waitForResponse();
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "bulbul", null, sync, null);
