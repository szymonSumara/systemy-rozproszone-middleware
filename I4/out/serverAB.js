...
const AServer_1 = __importDefault(require("./Servers/AServer"));
const BServer_1 = __importDefault(require("./Servers/BServer"));
function main() {
    var server = new grpc.Server();
    server.addService(services_grpc_pb_1.AService, new AServer_1.default());
...
main();
//# sourceMappingURL=serverAB.js.map